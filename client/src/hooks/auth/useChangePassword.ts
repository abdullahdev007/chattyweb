...
const useChangePassword = () => {
  ...
  const changePassword = async ({ password, confirmPassword }: ChangePasswordParams): Promise<void> => {
...
function handleInputErrors({ password, confirmPassword }: ChangePasswordParams): boolean {
