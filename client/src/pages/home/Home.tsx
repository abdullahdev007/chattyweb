...
const Home: FC = () => {
  return (
    <>
      <div className="bg-base-200 bg-opacity-70 shadow-lg rounded-lg overflow-hidden w-full h-full max-h-[calc(100vh-200px)] flex flex-col sm:flex-row xl:mx-24 lg:mx-12 md:mx-0  max-sm:my-12">
        <Sidebar />
        <MessageContainer />
      </div>
      <AddFriendModal />
